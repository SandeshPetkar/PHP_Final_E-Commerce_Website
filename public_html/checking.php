...
if (isset($_POST['signup'])) {
    ...
    sendMail($email,"Registration Successfull!!!!!",$body);
...
if (isset($_POST['checkout'])) {
    ...
    sendMail($_SESSION['email'],"$orderid - Order Placed Successfully !!!","Hi $name,\n\nYour order with order ID - $orderid has been successfully placed.\n\n Order Details:\n\nPayment Type: $payment\nTotal Amount:$totalamount\nAddress:$address\n\nBelow are the porducts included in the order.\n\n$datastring\n\n\nNote: If you have selected online payment. Then complete that first then only your order will be dispatched.\n\n\n\n\nThanks,\nSandesh");
